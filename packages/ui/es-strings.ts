const strings: { [k: string]: string } = {
  ...
  'E-Book Help': 'Ayuda para Libros Electrónicos',
  ...
  'Best for reading on a computer, phone, or tablet.':
    'La mejor opción para leer en computadora, teléfono o tablet.',
  ...
  'Best for most apps and platforms, including iOS.':
    'El mejor formato para la mayoría de aplicaciones y plataformas, incluyendo iOS.',
  'Best on Amazon devices, Kindle app, and Android.':
    'El mejor formato para los dispositivos Amazon, aplicaciones de Kindle y Android.',
