...
const Formats: React.FC = () => (
  <section className="Formats py-16 px-12 relative">
    ...
    <p className="font-serif antialiased text-xl text-gray-700 leading-relaxed md:pr-64">
    ...
    <p className="mt-8 font-serif antialiased text-xl text-gray-700 leading-relaxed md:pr-32 lg:pr-64">
