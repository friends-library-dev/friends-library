...
var Cover = function (props) {
    var title = props.title, author = props.author, isbn = props.isbn, edition = props.edition, blurb = props.blurb, showGuides = props.showGuides;
    var _a = initials(author), firstInitial = _a[0], lastInitial = _a[1];
    return (react_1["default"].createElement("div", { className: "cover" + (showGuides ? ' cover--show-guides' : '') },
        browser_or_node_1.isBrowser && react_1["default"].createElement("div", { className: "cover-mask" }),
        react_1["default"].createElement("div", { className: "bg-block" }),
        react_1["default"].createElement("div", { className: "back" },
            react_1["default"].createElement("div", { className: "back__safe" },
        ...
        react_1["default"].createElement("div", { className: "front" },
            react_1["default"].createElement("div", { className: "front__safe" },
        ...
        browser_or_node_1.isBrowser && (react_1["default"].createElement(react_1["default"].Fragment, null,
