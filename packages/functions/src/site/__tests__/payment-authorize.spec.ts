import handler from '../payment-authorize';
...
describe('/payment-authorize handler', () => {
  it('should return 201 with chargeId if successful', async () => {
    ...
    const { res, json } = await invokeCb(handler, { body: JSON.stringify(body) });
