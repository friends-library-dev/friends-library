...
export default () => (
  <Section id="poetry">
    ...
    <Para>
      Poetry is marked up first with a line containing
      only <Code>[verse]</Code>, followed by the poetry
    ...
    <Para>
      <i>Stanzas</i> in poetry are indicated by leaving
      an <b>extra blank line</b> between them:
    </Para>
    ...
    <Note>
      ...
      must terminate with a space then another backtick.
    </Note>
    <Note>
      Browsers can't render footnotes
      like <a href="https://www.princexml.com">Prince</a> can, hence
